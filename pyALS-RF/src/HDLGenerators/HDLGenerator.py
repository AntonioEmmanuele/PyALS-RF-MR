...
class HDLGenerator:
    ...
    vhd_mr_solver_source = "vhd/mr_solver.vhd"
    vhd_mr_classifier_source_template = "vhd/classifier_mr.vhd.template"
    # sh files
    ...
    def generate_classifier(self, dest, features, trees, env, data_width):
